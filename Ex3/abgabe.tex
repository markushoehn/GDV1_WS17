...
= 
\begin{pmatrix}
	-\frac{-n}{-f} \cdot tan(\frac{\Theta}{2})\cdot (-f)\\
	-\frac{-n}{-f} \cdot(-f)-(-f-n) \\
	1 \\
\end{pmatrix}\\
= 
\begin{pmatrix}
	n \cdot tan(\frac{\Theta}{2})\\
	f+2n \\
	1 \\
\end{pmatrix}
$ \\
...
=
\begin{pmatrix}
	-\frac{-n}{-f} \cdot tan(\frac{\Theta}{2})\cdot (-n)\\
	-\frac{-n}{-n} \cdot(-f)-(-f-n) \\
	1 \\
\end{pmatrix}\\
= 
\begin{pmatrix}
	\frac{n^2}{f} \cdot tan(\frac{\Theta}{2})\\
	2f+n \\
	1 \\
\end{pmatrix}
$ \\
...
=
\begin{pmatrix}
	-\frac{-n}{-n} \cdot(-tan(\frac{\Theta}{2}))\cdot (-n)\\
	-\frac{-n}{-n} \cdot(-f)-(-f-n) \\
	1 \\
\end{pmatrix}\\
= 
